  ...
  return (
    <div className="min-h-screen bg-[#071326] flex flex-col items-center justify-center p-4">
      ...
      <div className="mb-8 flex items-center gap-3">
        ...
        <span className="text-2xl font-bold text-[#071326]/90">NOSMarket</span>
      </div>

      {/* Back to Home Button */}
      <Link
        href="/shop"
        className="mb-4 flex items-center gap-2 text-sm text-slate-600 hover:text-[#071326]/90 transition-colors"
      >
      ...
      {/* Form Card */}
      <div className="w-full max-w-[380px] rounded-[22px] border border-white/50 bg-white/60 backdrop-blur-[40px] saturate-[180%] shadow-[0_8px_40px_rgba(30,144,255,0.15),inset_0_1px_0_rgba(255,255,255,0.1)] p-6 sm:p-8 relative overflow-hidden">
        <h1 className="mb-6 text-center text-xl font-semibold text-[#071326]/90">Đăng Nhập</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-600 hover:text-[#071326]/90"
              >
          ...
          {/* Error Message */}
          {loi && (
            <div className="rounded-[10px] bg-[#FF4D4F]/10 p-3 text-sm text-red-600">
              {loi}
            </div>
          )}
          ...
          <button
            type="submit"
            disabled={dangTai}
            className="w-full rounded-[14px] bg-gradient-to-r from-[#2F9BE6] to-[#1a6cb8] py-3.5 font-medium text-[#071326]/90 transition-all hover:from-[#49B6FF] hover:to-[#2F9BE6] disabled:cursor-not-allowed disabled:opacity-50"
          >
            {dangTai ? (
        ...
        <div className="mt-6 text-center text-sm text-slate-600">
          Chưa có tài khoản?{" "}
          <Link href="/dang-ky" className="font-medium text-slate-600 hover:text-slate-600">
            Đăng ký ngay
          </Link>
        </div>
      </div>
