...
export default function NapTienPage() {
 ...
 {/* Header */}
 <div className="sticky top-0 z-40 border-b border-white/40 bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)] border border-white/50 shadow-lg backdrop-blur-sm">
 ...
 className="rounded-full bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)] p-3 transition-all hover:bg-white/60 backdrop-blur-md active:scale-95"
 title="Lam moi"
 >
 ...
 {successMsg && (
 <div className="mb-4 flex items-center gap-2 rounded-[12px] border border-[#3DDC84]/30 bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)] p-3">
 ...
 : "text-slate-600 hover:bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]"
 }`}
 >
 ...
 : "border-white/40 bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)] text-[#071326]/90/90 hover:bg-white/60 backdrop-blur-md"
 }`}
 >
 {copiedMaGD ? (
 ...
 className="w-full rounded-[14px] border border-white/40 bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)] py-3 font-medium text-[#071326]/90/90 transition-all hover:bg-white/60 backdrop-blur-md disabled:opacity-50"
 >
 ...
 className="w-full rounded-[14px] border border-white/40 bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)] py-3 font-medium text-slate-600 transition-all hover:bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]"
 >
 Tao moi
 </button>
 </div>
 ...
 ? "border-[#3DDC84]/30 bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]"
