...
function PayContent() {
 ...
 <a href="/shop" className="inline-block bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)] hover:bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)] px-6 py-3 rounded-[14px] font-medium transition-colors">Back to Shop</a>
 </div>
 </main>
 );
 }
 ...
 <p>2. Include Order ID in note: <code className="bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)] px-2 py-0.5 rounded">{memoExpected}</code></p>
 ...
 <p>2. Include Order ID: <code className="bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)] px-2 py-0.5 rounded">{memoExpected}</code></p>
 <p>3. Send exact amount: <strong>{amount}</strong></p>
 </div>
 </div>
 )}
 ...
 <p>2. Include Order ID where your wallet allows: <code className="bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)] px-2 py-0.5 rounded">{memoExpected}</code></p>
 ...
 {items.length === 0 && <p className="text-sm text-slate-600">No order items found.</p>}

 {items.map((item, index) => (
 <div key={item.name + String(index)} className="flex justify-between gap-4 text-sm">
 <span className="text-slate-600">{item.name} ({formatPurchasedQtyLabel(item)})</span>
 <span className="text-slate-600 shrink-0">{formatPrice(item.price * item.quantity, timezoneInfo.currencyCode, timezoneInfo.currencySymbol)}</span>
 </div>
 ))}
 ...
 <span className="text-slate-600">{timezoneInfo.currencyCode}</span>
 </div>
 </div>
