...
function LoadingScreen() {
  return (
    <div className="min-h-screen bg-[#071326] text-white/90 flex items-center justify-center">
...
function PayContent() {
  ...
  if (!orderId) {
    return (
      <main className="min-h-screen bg-[#071326] text-white/90 flex items-center justify-center p-4">
    ...
    <>
          ...
          <div className="w-full max-w-md rounded-[20px] border border-[#FF4D4F]/30 bg-white/5 p-6 shadow-2xl animate-bounce-in">
            <div className="mb-4 flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-lg font-semibold text-white/90 mb-2">Error</h3>
                <p className="text-sm text-blue-200/70 leading-relaxed break-words">{paymentError}</p>
              </div>
            </div>
            <button
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_360px]">
        <section className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              {PAYMENT_METHODS.map((paymentMethod) => (
                <button
                  ...
                  className={"px-4 py-2 rounded-[14px] border text-sm font-medium transition-all " + (selectedMethod === paymentMethod.value ? "bg-[#2F9BE6] border-blue-500 text-white/90 shadow-lg" : "bg-[#071326] border-white/10 text-blue-200/70 hover:bg-[#1E1E1E]")}
                >
                  {paymentMethod.label}
                </button>
              ))}
          ...
          <div className="bg-white/5 border border-white/10 rounded-[16px] p-6 space-y-5">
            ...
            {selectedMethod === "paypal_ff" && (
              <div className="space-y-5">
                ...
                <div className="rounded-[14px] border border-white/10 bg-[#071326]/60 p-4 text-sm text-blue-200/70 space-y-1">
            ...
            {selectedMethod === "ltc" && (
              <div className="space-y-5">
                ...
                {ltcQrImageUrl && (
                  <img src={ltcQrImageUrl} alt="Litecoin payment QR code" className="w-48 h-48 rounded-[14px] border border-white/10 bg-white p-2" />
                )}
                <div className="rounded-[14px] border border-white/10 bg-[#071326]/60 p-4 text-sm text-blue-200/70 space-y-1">
                  <p className="font-medium text-white/90">Instructions:</p>
        ...
        <aside className="bg-white/5 border border-white/10 rounded-[16px] p-6 h-fit sticky top-24">
    ...
    <div>
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          disabled={!value}
          className={"px-4 py-3 rounded-[14px] text-white/90 transition-all shrink-0 " + (value ? "bg-[#1E1E1E] hover:bg-[#1E1E1E]" : "bg-white/5 opacity-40 cursor-not-allowed")}
        >
