  ...
  return (
    <div className="min-h-screen bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex items-center justify-between animate-fade-in-up">
          <div className="flex items-center gap-4">
            <Link
              href="/shop"
              className="flex items-center gap-2 rounded-[14px] bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)] px-4 py-2 transition-colors hover:bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]0 backdrop-blur-md"
            >
            ...
            <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              {proofs.map((proof, idx) => {
                ...
                return (
                  <div
                    key={proof.id}
                    className="animate-vouch-entrance rounded-[16px] border border-white/40/60 bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]/90 p-5 backdrop-blur-sm transition-all hover:border-white/40/50"
                            ...
                            {isAdmin && (
                              <div className="absolute right-2 top-2 flex gap-1 opacity-100 sm:opacity-0 sm:transition-opacity sm:group-hover:opacity-100">
                                ...
                                <button
                                  ...
                                  className="inline-flex h-8 w-8 items-center justify-center rounded bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]/90 text-[#071326]/90/90 hover:bg-[#FF4D4F]"
                                  title="Delete image"
                                >
                          ...
                          {isEditing ? (
                            <>
                              <button
                                ...
                                disabled={saving}
                                className="rounded bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)] p-1.5 text-[#071326]/90/90 transition-colors hover:bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]/90 disabled:opacity-50"
                                title="Lưu"
                              >
                              ...
                              <button
                                type="button"
                                onClick={cancelEdit}
                                className="rounded bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]0 backdrop-blur-md p-1.5 text-[#071326]/90/90 transition-colors hover:bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]0 backdrop-blur-md"
                                title="Hủy"
                              >
                                <X className="h-4 w-4" />
                              </button>
                            ...
                            <>
                              <button
                                ...
                                className="rounded bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]0 backdrop-blur-md p-1.5 text-[#071326]/90/90 transition-colors hover:bg-white/60 hover:shadow-[0_4px_20px_rgba(255,255,255,0.4)]"
                                title="Sửa"
                              >
                              ...
                              <button
                                ...
                                className="rounded bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]0 backdrop-blur-md p-1.5 text-[#071326]/90/90 transition-colors hover:bg-[#FF4D4F]/90"
                                title="Xóa"
                              >
                                <Trash2 className="h-4 w-4" />
                              </button>
      ...
      {lightbox && activeImages.length > 0 && (
        <div
          className={
            "fixed inset-0 z-50 flex items-center justify-center bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]0 backdrop-blur-sm/95 p-4 " +
            (closing ? "animate-fade-out" : "animate-fade-in")
          }
          onClick={closeLightbox}
        >
          <button
            className="absolute right-4 top-4 rounded-[14px] bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)] p-2 transition-colors hover:bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]0 backdrop-blur-md"
            onClick={closeLightbox}
          >
          ...
          {activeImages.length > 1 && (
            <button
              className="absolute left-4 top-1/2 -translate-y-1/2 rounded-full bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]/90 p-3"
              onClick={(e) => {
                e.stopPropagation()
                prevImage()
              }}
          ...
          {activeImages.length > 1 && (
            <button
              className="absolute right-4 top-1/2 -translate-y-1/2 rounded-full bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]/90 p-3"
              onClick={(e) => {
                e.stopPropagation()
                nextImage()
              }}
          ...
          {activeImages.length > 1 && (
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 rounded-full bg-white/40 backdrop-blur-md border border-white/50 shadow-[0_4px_15px_rgba(255,255,255,0.2)]/90 px-4 py-2 text-sm font-medium text-[#071326]/90/90">
