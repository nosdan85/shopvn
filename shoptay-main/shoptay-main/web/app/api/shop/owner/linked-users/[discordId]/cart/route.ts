...
export async function DELETE(request: NextRequest, { params }: RouteContext) {
  try {
    ...
    const res = await fetch(`${API_BASE_URL}/api/shop/owner/linked-users/${encodeURIComponent(discordId)}/cart`, {
      method: "DELETE",
    ...
    console.error("[owner/linked-users cart proxy] DELETE failed:", error);
